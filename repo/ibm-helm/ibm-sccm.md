...
```bash
$ helm install my-release -f values.yaml ibm-sccm-4.2.8.tgz
```
...
```bash
helm install <release-name> -f my-values.yaml ibm-sccm-4.2.8.tgz
```
...
```sh
helm upgrade my-release -f values.yaml ibm-sccm-4.2.8.gz
```
